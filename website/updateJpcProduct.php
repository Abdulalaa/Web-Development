...
if (!isset($_POST['jpcProductID']) || !is_numeric($_POST['jpcProductID'])) {
    echo "<h2>You did not select a valid Product ID value</h2>\n";
    echo '<a href="jpcIndex.php?content=listJpcProduct">List Products</a>';
    exit;
}

$jpcProductID = filter_var($_POST['jpcProductID'], FILTER_VALIDATE_INT);
